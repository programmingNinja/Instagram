...
public class SearchTagResultsAdapter extends RecyclerView.Adapter<SearchTagResultsAdapter.SearchTagItemViewHolder> {
    ...
    @Override
    public SearchTagResultsAdapter.SearchTagItemViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View itemView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_search_tag_result, viewGroup, false);
        return new SearchTagItemViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(SearchTagResultsAdapter.SearchTagItemViewHolder holder, int position) {
    ...
    public final class SearchTagItemViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        TextView tvTag;
